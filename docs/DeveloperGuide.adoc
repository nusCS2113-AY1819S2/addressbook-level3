...
*Has a need to collect and view specific data regarding the league and teams and players information in the league  
*Prefer typing over mouse input
*Prefer desktop apps over other type
*Reasonably comfortable using CLI apps


*Value proposition*: manage League faster than a typical mouse/GUI driven app
