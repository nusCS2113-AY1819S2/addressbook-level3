...
=== Use case: UC04 - Managing appointments
...
. User requests to view patient at a certain index in the list.
...
. User requests to view patient will all particulars at a certain index in the list.
