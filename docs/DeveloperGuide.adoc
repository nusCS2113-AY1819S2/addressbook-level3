...
. User adds a person in the address book.
. AddressBook adds person to address book and prints the newly added person's details.
+
Use case ends.
...
** 1a2. User re-enters new person's particulars.
