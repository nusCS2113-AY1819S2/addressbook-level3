...
image::ClassDiagram.png["800"]

//@@author WuPeiHsuan

`Main` has only one class called link:{repoURL}/src/main/java/seedu/address/Main.java[`Main`]. It is responsible for,
...
* Only UI and Data defines its _API_ in an `interface`.
