...
== View the last command you typed in previously : `last`

Displays the last command you typed in(not including 'last') previously +
Format: `last`
...
* `add something` +
This is the previous command for demo.

* `last` +
`add something` +
Displays the last command `add something`
