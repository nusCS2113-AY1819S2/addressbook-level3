...
Finds persons whose details(name, address, email) contain any of the given keywords. +
Format: `find KEYWORD [MORE_KEYWORDS]`

[NOTE]
====
The search is case insensitive, the order of the keywords does not matter,
...
* `find Clementi` +
Returns Any person having addresses `Clementi`

* `find abc@email.com` +
Returns Any person having email `abc@email.com`
